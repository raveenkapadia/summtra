...
const INDIAN_CITIES = [
  // West India (8)
  { name: 'Mumbai', state: 'Maharashtra', country: 'India', region: 'West India', lat: 19.0760, lng: 72.8777 },
  { name: 'Pune', state: 'Maharashtra', country: 'India', region: 'West India', lat: 18.5204, lng: 73.8567 },
  { name: 'Ahmedabad', state: 'Gujarat', country: 'India', region: 'West India', lat: 23.0225, lng: 72.5714 },
  { name: 'Surat', state: 'Gujarat', country: 'India', region: 'West India', lat: 21.1702, lng: 72.8311 },
  { name: 'Goa', state: 'Goa', country: 'India', region: 'West India', lat: 15.2993, lng: 74.1240 },
  { name: 'Nagpur', state: 'Maharashtra', country: 'India', region: 'West India', lat: 21.1458, lng: 79.0882 },
  { name: 'Udaipur', state: 'Rajasthan', country: 'India', region: 'West India', lat: 24.5854, lng: 73.7125 },
  { name: 'Jaisalmer', state: 'Rajasthan', country: 'India', region: 'West India', lat: 26.9157, lng: 70.9083 },
  // North India (9)
  { name: 'Delhi', state: 'Delhi', country: 'India', region: 'North India', lat: 28.7041, lng: 77.1025 },
  { name: 'Jaipur', state: 'Rajasthan', country: 'India', region: 'North India', lat: 26.9124, lng: 75.7873 },
  { name: 'Lucknow', state: 'Uttar Pradesh', country: 'India', region: 'North India', lat: 26.8467, lng: 80.9462 },
  { name: 'Chandigarh', state: 'Punjab', country: 'India', region: 'North India', lat: 30.7333, lng: 76.7794 },
  { name: 'Varanasi', state: 'Uttar Pradesh', country: 'India', region: 'North India', lat: 25.3176, lng: 82.9739 },
  { name: 'Rishikesh', state: 'Uttarakhand', country: 'India', region: 'North India', lat: 30.0869, lng: 78.2676 },
  { name: 'Amritsar', state: 'Punjab', country: 'India', region: 'North India', lat: 31.6340, lng: 74.8723 },
  { name: 'Shimla', state: 'Himachal Pradesh', country: 'India', region: 'North India', lat: 31.1048, lng: 77.1734 },
  { name: 'Agra', state: 'Uttar Pradesh', country: 'India', region: 'North India', lat: 27.1767, lng: 78.0081 },
  // South India (7)
  { name: 'Bangalore', state: 'Karnataka', country: 'India', region: 'South India', lat: 12.9716, lng: 77.5946 },
  { name: 'Chennai', state: 'Tamil Nadu', country: 'India', region: 'South India', lat: 13.0827, lng: 80.2707 },
  { name: 'Hyderabad', state: 'Telangana', country: 'India', region: 'South India', lat: 17.3850, lng: 78.4867 },
  { name: 'Kochi', state: 'Kerala', country: 'India', region: 'South India', lat: 9.9312, lng: 76.2673 },
  { name: 'Mysore', state: 'Karnataka', country: 'India', region: 'South India', lat: 12.2958, lng: 76.6394 },
  { name: 'Thiruvananthapuram', state: 'Kerala', country: 'India', region: 'South India', lat: 8.5241, lng: 76.9366 },
  { name: 'Coimbatore', state: 'Tamil Nadu', country: 'India', region: 'South India', lat: 11.0168, lng: 76.9558 },
  // East India (4)
  { name: 'Kolkata', state: 'West Bengal', country: 'India', region: 'East India', lat: 22.5726, lng: 88.3639 },
  { name: 'Darjeeling', state: 'West Bengal', country: 'India', region: 'East India', lat: 27.0410, lng: 88.2663 },
  { name: 'Patna', state: 'Bihar', country: 'India', region: 'East India', lat: 25.5941, lng: 85.1376 },
  { name: 'Guwahati', state: 'Assam', country: 'India', region: 'East India', lat: 26.1445, lng: 91.7362 },
  // Central India (3)
  { name: 'Bhopal', state: 'Madhya Pradesh', country: 'India', region: 'Central India', lat: 23.2599, lng: 77.4126 },
  { name: 'Indore', state: 'Madhya Pradesh', country: 'India', region: 'Central India', lat: 22.7196, lng: 75.8577 },
  { name: 'Visakhapatnam', state: 'Andhra Pradesh', country: 'India', region: 'Central India', lat: 17.6868, lng: 83.2185 }
];
...
const INTERNATIONAL_CITIES = [
  ...
  { name: 'Moscow', country: 'Russia', region: 'Europe', lat: 55.7558, lng: 37.6173 },
  // Middle East (6)
  { name: 'Dubai', country: 'UAE', region: 'Middle East', lat: 25.2048, lng: 55.2708 },
  { name: 'Abu Dhabi', country: 'UAE', region: 'Middle East', lat: 24.4539, lng: 54.3773 },
  { name: 'Doha', country: 'Qatar', region: 'Middle East', lat: 25.2854, lng: 51.5310 },
  { name: 'Riyadh', country: 'Saudi Arabia', region: 'Middle East', lat: 24.7136, lng: 46.6753 },
  { name: 'Tel Aviv', country: 'Israel', region: 'Middle East', lat: 32.0853, lng: 34.7818 },
  { name: 'Istanbul', country: 'Turkey', region: 'Middle East', lat: 41.0082, lng: 28.9784 },
  // Southeast Asia (5)
  { name: 'Singapore', country: 'Singapore', region: 'Southeast Asia', lat: 1.3521, lng: 103.8198 },
  { name: 'Bangkok', country: 'Thailand', region: 'Southeast Asia', lat: 13.7563, lng: 100.5018 },
  { name: 'Kuala Lumpur', country: 'Malaysia', region: 'Southeast Asia', lat: 3.1390, lng: 101.6869 },
  { name: 'Jakarta', country: 'Indonesia', region: 'Southeast Asia', lat: -6.2088, lng: 106.8456 },
  { name: 'Manila', country: 'Philippines', region: 'Southeast Asia', lat: 14.5995, lng: 120.9842 },
  // East Asia (6)
  { name: 'Hong Kong', country: 'Hong Kong', region: 'East Asia', lat: 22.3193, lng: 114.1694 },
  { name: 'Tokyo', country: 'Japan', region: 'East Asia', lat: 35.6762, lng: 139.6503 },
  { name: 'Seoul', country: 'South Korea', region: 'East Asia', lat: 37.5665, lng: 126.9780 },
  { name: 'Shanghai', country: 'China', region: 'East Asia', lat: 31.2304, lng: 121.4737 },
  { name: 'Beijing', country: 'China', region: 'East Asia', lat: 39.9042, lng: 116.4074 },
  { name: 'Taipei', country: 'Taiwan', region: 'East Asia', lat: 25.0330, lng: 121.5654 },
  // Australia & Oceania (3)
  { name: 'Sydney', country: 'Australia', region: 'Australia & Oceania', lat: -33.8688, lng: 151.2093 },
  { name: 'Melbourne', country: 'Australia', region: 'Australia & Oceania', lat: -37.8136, lng: 144.9631 },
  { name: 'Auckland', country: 'New Zealand', region: 'Australia & Oceania', lat: -36.8509, lng: 174.7645 },
  // North America (11)
  { name: 'New York', country: 'USA', region: 'North America', lat: 40.7128, lng: -74.0060 },
  ...
  { name: 'Johannesburg', country: 'South Africa', region: 'Africa', lat: -26.2041, lng: 28.0473 },
  { name: 'Cairo', country: 'Egypt', region: 'Africa', lat: 30.0444, lng: 31.2357 },
  { name: 'Nairobi', country: 'Kenya', region: 'Africa', lat: -1.2921, lng: 36.8219 },
  { name: 'Lagos', country: 'Nigeria', region: 'Africa', lat: 6.5244, lng: 3.3792 },
  { name: 'Casablanca', country: 'Morocco', region: 'Africa', lat: 33.5731, lng: -7.5898 },
  { name: 'Marrakech', country: 'Morocco', region: 'Africa', lat: 31.6295, lng: -7.9811 }
];
